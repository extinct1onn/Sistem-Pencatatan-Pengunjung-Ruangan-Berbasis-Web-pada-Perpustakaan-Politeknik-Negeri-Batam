<?php
session_start();
require_once 'includes/db.php';   // pastikan file ini membuat $conn = new mysqli(...)
...
if (!$stmt) {
    // Tampilkan pesan error agar mudah didebug
    die('Prepare failed: ' . $conn->error);
}

/* ---------- Bind parameter (metode dinamis) ---------- */
...
$visits = $result->fetch_all(MYSQLI_ASSOC);   // PHP 5.3+ pakai while fetch_assoc
$stmt->close();
...
<head>
    ...
    <title>Rekapitulasi Ruang Baca - Pencatatan Pengunjung</title>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="submenu show" id="rekapitulasiSubmenu">
                                <li><a href="rekapitulasi_ruang_baca.php" class="active"><i class="fas fa-book"></i><span>Ruang Baca</span></a></li>
            ...
            <main class="main-content" id="mainContent">
                ...
                <section class="cards">
                    <div class="card blue">
                        <div class="card-content">
                            <h3><?= $total_visits ?></h3>
                            <p>TOTAL PENGUNJUNG RUANG BACA</p>
                        </div>
                ...
                <section class="filter-section">
                    ...
                    <form method="get" action="" class="filter-form">
                        ...
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <a href="rekapitulasi_ruang_baca.php" class="btn-reset"><i class="fas fa-redo"></i> Reset</a>
                        </div>
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <a href="export_ruang_baca.php?start_date=<?= urlencode($start_date) ?>&end_date=<?= urlencode($end_date) ?>&keyword=<?= urlencode($keyword) ?>" class="btn-export"><i class="fas fa-file-excel"></i> Export Excel</a>
                        </div>
                    </form>
                </section>
                ...
                <section class="recent-visitors">
                    <h3>Daftar Pengunjung Ruang Baca</h3>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php if ($visits): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr><td colspan="5" class="text-center">Tidak ada data pengunjung Ruang Baca.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
