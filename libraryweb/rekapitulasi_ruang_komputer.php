...
if (!$stmt) {                 // prepare gagal?
    die('Prepare failed: ' . $conn->error);
}

/* bind dinamis (kompatibel PHP 5.3+) */
...
<head>
    ...
    <title>Rekapitulasi Ruang Komputer - Pencatatan Pengunjung</title>
        ...
        <div class="content-body">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="submenu show" id="rekapitulasiSubmenu">
                                ...
                                <li><a href="rekapitulasi_ruang_komputer.php" class="active"><i class="fas fa-desktop"></i><span>Ruang Komputer</span></a></li>
                            </ul>
                        </li>
            ...
            <main class="main-content" id="mainContent">
                <div class="main-header">
                    <h1>Rekapitulasi Ruang Komputer <span>Data Pengunjung Ruang Komputer</span></h1>
                    <ol class="breadcrumb">
                        <li><a href="admin_dashboard.php" style="text-decoration: none;"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                        <li> / Rekapitulasi Ruang Komputer</li>
                    </ol>
                </div>
                ...
                <section class="cards">
                    <div class="card orange">
                        <div class="card-content">
                            <h3><?= $total_visits ?></h3>
                            <p>TOTAL PENGUNJUNG RUANG KOMPUTER</p>
                        </div>
                ...
                <section class="filter-section">
                    ...
                    <form method="get" action="" class="filter-form">
                        ...
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <a href="rekapitulasi_ruang_komputer.php" class="btn-reset"><i class="fas fa-redo"></i> Reset</a>
                        </div>
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <a href="export_ruang_komputer.php?start_date=<?= urlencode($start_date) ?>&end_date=<?= urlencode($end_date) ?>&keyword=<?= urlencode($keyword) ?>" class="btn-export"><i class="fas fa-file-excel"></i> Export Excel</a>
                        </div>
                    </form>
                </section>
                ...
                <section class="recent-visitors">
                    <h3>Daftar Pengunjung Ruang Komputer</h3>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php if ($visits): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr><td colspan="5" class="text-center">Tidak ada data pengunjung Ruang Komputer.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
